...
//        observation[1] = new Bird(LocalDate.of(2022, 8, 16), Species.КАНАРЕЕЧНЫЙ_ВЬЮРОК, "male", "adult", Place.HRODNA, 1, "Поющий самец.");
//
//        for (Bird value : observation) {
//            System.out.println(value.getLocDate() + ", " + value.getSpecies() + "; " + value.getSex() + ", " + value.getAge() + ", " +
